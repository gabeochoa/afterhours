...
struct any_of_checker {
    ...
    bool operator()(const T& t, const Cs&... compare) const {
        ...
        trompeloeil::ignore(std::initializer_list<bool>{
            (any_true = any_true ||
                        trompeloeil::param_matches(compare, std::ref(t)))...});
        return any_true;
    }
};
...
template<typename Type = trompeloeil::wildcard, typename... Cs,
         typename R = make_matcher_return<Type, impl::any_of_checker,
                                          impl::any_of_printer, Cs...> >
R any_of(Cs&&... cs) {
...
template<typename Type = trompeloeil::wildcard, typename... Cs,
         typename R = make_matcher_return<Type, impl::none_of_checker,
                                          impl::none_of_printer, Cs...> >
R none_of(Cs&&... cs) {
...
template<typename Type = trompeloeil::wildcard, typename... Cs,
         typename R = make_matcher_return<Type, impl::all_of_checker,
                                          impl::all_of_printer, Cs...> >
R all_of(Cs&&... cs) {
