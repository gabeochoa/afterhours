...
struct disjunction {
    static constexpr bool test() {
        ...
        ignore(std::initializer_list<bool>{
            (all_false = all_false || Ts::value)...});
        return all_false;
    }
...
template<typename Type = trompeloeil::wildcard, typename... Es,
         typename = typename std::enable_if<
             !impl::disjunction<impl::is_range<Es>...>::value>::type,
         typename R = make_matcher_return<Type, impl::is_elements_checker,
...
struct is_range_checker {
    ...
    bool operator()(const R& r, const C& cs) const {
        using std::begin;
        using std::end;
        return std::equal(begin(r), end(r), begin(cs), end(cs),
                          [](const auto& rv, const auto& cv) {
                              return trompeloeil::param_matches(cv,
                                                                std::ref(rv));
                          });
    }
};
...
template<typename Type = trompeloeil::wildcard, typename C,
         ...
         typename R =
             make_matcher_return<Type, impl::is_range_checker,
                                 impl::is_range_printer, impl::store_as_t<C>>>
R range_is(C&& c) {
    return trompeloeil::make_matcher<Type>(
        impl::is_range_checker{}, impl::is_range_printer{},
...
template<typename Type = trompeloeil::wildcard, typename... Es,
         typename = typename std::enable_if<
             !impl::disjunction<impl::is_range<Es>...>::value>::type,
         typename R =
             make_matcher_return<Type, impl::is_permutation_elements_checker,
                                 impl::is_permutation_elements_printer, Es...>>
R range_is_permutation(Es&&... es) {
    return trompeloeil::make_matcher<Type>(
        impl::is_permutation_elements_checker{},
        impl::is_permutation_elements_printer{}, std::forward<Es>(es)...);
}
...
struct is_permutation_range_checker {
    ...
    bool operator()(const R& range, const C& elements) const {
        ...
        for (const auto& element : elements) {
            matchers.push_back(
                impl::make_predicate_matcher<element_type>(element));
        }
        while (it != e) {
            auto found = std::find_if(
                matchers.begin(), matchers.end(),
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename R = make_matcher_return<
             Type, impl::is_permutation_range_checker,
             impl::is_permutation_range_printer, impl::store_as_t<C>>>
...
template<
    typename Type = trompeloeil::wildcard, typename... Es,
    typename = typename std::enable_if<
        !impl::disjunction<impl::is_range<Es>...>::value>::type,
    typename R = make_matcher_return<Type, impl::includes_elements_checker,
                                     impl::includes_elements_printer, Es...>>
...
template<typename Type = trompeloeil::wildcard, typename C,
         ...
         typename R = make_matcher_return<Type, impl::includes_range_checker,
                                          impl::includes_range_printer,
                                          impl::store_as_t<C>>>
R range_includes(C&& c) {
    return trompeloeil::make_matcher<Type>(
        impl::includes_range_checker{}, impl::includes_range_printer{},
        impl::store_as<C>::make(std::forward<C>(c)));
}
...
struct range_all_of_checker {
    ...
    bool operator()(const R& range, const C& comp) const {
        ...
        auto it = begin(range);
        const auto e = end(range);
        return std::all_of(it, e, [&](const auto& t) {
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename R = make_matcher_return<Type, impl::range_all_of_checker,
                                          impl::range_all_of_printer, C>>
...
struct range_none_of_checker {
    ...
    bool operator()(const R& range, const C& comp) const {
        ...
        auto it = begin(range);
        const auto e = end(range);
        return std::none_of(it, e, [&](const auto& t) {
            return trompeloeil::param_matches(comp, std::ref(t));
        });
    }
};
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename R = make_matcher_return<Type, impl::range_none_of_checker,
                                          impl::range_none_of_printer, C>>
...
struct range_any_of_checker {
    ...
    bool operator()(const R& range, const C& comp) const {
        ...
        auto it = begin(range);
        const auto e = end(range);
        return std::any_of(it, e, [&](const auto& t) {
            return trompeloeil::param_matches(comp, std::ref(t));
        });
    }
};
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename R = make_matcher_return<Type, impl::range_any_of_checker,
                                          impl::range_any_of_printer, C>>
...
template<
    ...
    typename = typename std::enable_if<
        !impl::disjunction<impl::is_range<Es>...>::value>::type,
    typename R = make_matcher_return<Type, impl::starts_with_elements_checker,
                                     impl::starts_with_elements_printer, Es...>>
...
struct starts_with_range_checker {
    ...
    bool operator()(const R& range, const E& elements) const {
        ...
        using std::end;
        auto result =
            std::mismatch(begin(range), end(range), begin(elements),
                          end(elements), [](const auto& t, const auto& c) {
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename = typename std::enable_if<impl::is_range_v<C>>::type,
         typename R = make_matcher_return<Type, impl::starts_with_range_checker,
                                          impl::starts_with_range_printer,
                                          impl::store_as_t<C>>>
R range_starts_with(C&& c) {
    return trompeloeil::make_matcher<Type>(
        impl::starts_with_range_checker{}, impl::starts_with_range_printer{},
        impl::store_as<C>::make(std::forward<C>(c)));
}
...
struct ends_with_checker {
    ...
    bool operator()(const R& range, const Es&... elements) const {
        ...
        const auto num_values =
            static_cast<std::ptrdiff_t>(sizeof...(elements));
...
template<typename Type = trompeloeil::wildcard, typename... Es,
         typename = typename std::enable_if<
             !impl::disjunction<impl::is_range<Es>...>::value>::type,
         typename R = make_matcher_return<Type, impl::ends_with_checker,
                                          impl::ends_with_printer, Es...>>
...
struct ends_with_range_checker {
    ...
    bool operator()(const R& range, const E& elements) const {
        ...
        std::advance(it, size - num_values);
        auto result =
            std::mismatch(it, e, begin(elements), end(elements),
...
template<typename Type = trompeloeil::wildcard, typename C,
         typename = typename std::enable_if<impl::is_range_v<C>>::type,
         typename R = make_matcher_return<Type, impl::ends_with_range_checker,
                                          impl::ends_with_range_printer,
                                          impl::store_as_t<C>>>
R range_ends_with(C&& c) {
    return trompeloeil::make_matcher<Type>(
        impl::ends_with_range_checker{}, impl::ends_with_range_printer{},
        impl::store_as<C>::make(std::forward<C>(c)));
}
