...
struct EntityHelper {
  ...
  static EntityCollection *&get_thread_default_collection_ptr() {
    ...
    thread_local static EntityCollection *thread_default_collection = nullptr;
  ...
  static EntityCollection &get_default_collection() {
    EntityCollection *thread_collection = get_thread_default_collection_ptr();
  ...
  static Entity &
  createEntityWithOptions(const EntityCollection::CreationOptions &options) {
